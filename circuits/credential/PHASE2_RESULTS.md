...
Satisfies F2.6/D1's "constraint counts per configuration" requirement, plus the end-to-end proof validation from [`../../specs/phase-2/eligibility-circuits.md` §7](../../specs/phase-2/eligibility-circuits.md#7-f27--test-suite) — all three configurations have now gone through a real setup→prove→verify pass, not just witness generation.
